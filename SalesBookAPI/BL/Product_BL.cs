...
namespace SalesBookAPI.BL
{
    public class Product_BL
    {
        ...
        public JObject GetData(JObject data, Token t)
        {
            ...
            DataTable dtDataCount = StaticGeneral.GetDataTable("ProductMaster_Select", data, ExcludeParam, IncludeParam);

            IncludeParam["ResultType"] = "2";
            DataTable dtData = StaticGeneral.GetDataTable("ProductMaster_Select", data, ExcludeParam, IncludeParam);
        ...
        public JObject SaveData(JObject data, Token t)
        {
            ...
            DataTable dtData = StaticGeneral.GetDataTable("ProductMaster_Insert", data, ExcludeParam, IncludeParam);
        ...
        public JObject UpdateData(JObject data, Token t)
        {
            ...
            DataTable dtData = StaticGeneral.GetDataTable("ProductMaster_Update", data, ExcludeParam, IncludeParam);
        ...
        public JObject DeleteData(int Code, Token t)
        {
            ...
            IncludeParam.Add("SessionID", t.SessionID);
            DataTable dtData = StaticGeneral.GetDataTable("ProductMaster_Delete", IncludeParam);
