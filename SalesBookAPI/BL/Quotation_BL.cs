    ...
    public class Quotation_BL
    {
        ...
        public string getUserReportPDF(JObject data, Token t)
        {
            ...
            try
            {
                ...
                filename = "Quotation" + "_" + data["InvoiceNo"].ToString().Replace("/", "_") + "_" + DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".pdf";
                ...
                DataTable dtData = StaticGeneral.GetDataTable("pRpt_Quotation", IncludeParam, true, 120);
                ...
                using (ReportViewer rptvw = new ReportViewer())
                {
                    ...
                    rptvw.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/Reports/Quotation.rdlc");
